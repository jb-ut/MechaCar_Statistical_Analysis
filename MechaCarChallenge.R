...
### DELIVERABLE 1 ###
# Import the data
mecha_car_mpg <- read.csv(file='C:/Users/johns/MechaCar_Statistical_Analysis/MechaCar_mpg.csv',check.names = F, stringsAsFactors = F)
...
### DELIVERABLE 2 ###
# Import the data
sus_coil <- read.csv(file='C:/Users/johns/MechaCar_Statistical_Analysis/Suspension_Coil.csv', check.names = F, stringsAsFactors = F)
